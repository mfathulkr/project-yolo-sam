...
def main() -> None:
    ...
    effects = pd.read_csv(analysis_root / "paired_reference_effects.csv")
    advantages = pd.read_csv(analysis_root / "teacher_advantage.csv")
    agreements = pd.read_csv(analysis_root / "reference_agreement.csv")
    detector = pd.read_csv(analysis_root / "detector_seed_summary.csv")
    metrics = pd.read_csv(analysis_root / "canonical_instance_metrics.csv")
    ...
    manifest = write_manifest(table_paths, figure_paths)
