...
- `studies/semantic_drone_car_study/configs/yolo26x.yaml`

Dataset preparation:

- `studies/semantic_drone_car_study/scripts/prepare_semantic_drone_dataset.py`
- `studies/semantic_drone_car_study/src/semantic_drone_car/data.py`
