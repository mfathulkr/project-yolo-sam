# SAMRS SOTA Plane - Yeniden üretilmiş SAM1 pseudo referansı Full Metric Document
...
- Bu belgede değerlendirme referansı Yeniden üretilmiş SAM1 pseudo referansı ve değerlendirilen instance sayısı 3.713.
...
## Yeniden üretilmiş SAM1 pseudo referansı

Bütün SAM1/2/3 tahminleri değişmeden tutulmuş ve Yeniden üretilmiş SAM1 pseudo referansı ile değerlendirilmiştir.

### Overall

Referans: Yeniden üretilmiş SAM1 pseudo referansı. Bu tablo 512 görüntüdeki 3.713 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.
...
| SAM1 YOLO bbox | 512 | 0.818 | 0.829 | 0.831 | 0.828 | 0.840 | 0.827 | 0.788 |
| SAM2 GT bbox | 512 | 0.785 | 0.870 | 0.817 | 0.957 | 0.941 | 0.697 | 0.238 |
| SAM2 YOLO bbox | 512 | 0.682 | 0.748 | 0.708 | 0.809 | 0.808 | 0.645 | 0.242 |
| SAM3 GT bbox | 512 | 0.813 | 0.890 | 0.929 | 0.868 | 0.975 | 0.783 | 0.227 |
| SAM3 YOLO bbox | 512 | 0.695 | 0.758 | 0.797 | 0.731 | 0.829 | 0.685 | 0.215 |

### No Overlap × Low Mask Area

Referans: Yeniden üretilmiş SAM1 pseudo referansı. Bu tablo 128 görüntüdeki 286 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 128 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM1 YOLO bbox | 128 | 0.784 | 0.798 | 0.792 | 0.807 | 0.815 | 0.787 | 0.752 |
| SAM2 GT bbox | 128 | 0.784 | 0.870 | 0.812 | 0.964 | 0.937 | 0.741 | 0.210 |
| SAM2 YOLO bbox | 128 | 0.646 | 0.713 | 0.666 | 0.790 | 0.769 | 0.591 | 0.206 |
| SAM3 GT bbox | 128 | 0.825 | 0.900 | 0.922 | 0.890 | 0.986 | 0.839 | 0.189 |
| SAM3 YOLO bbox | 128 | 0.672 | 0.732 | 0.748 | 0.729 | 0.797 | 0.692 | 0.178 |

### No Overlap × High Mask Area

Referans: Yeniden üretilmiş SAM1 pseudo referansı. Bu tablo 128 görüntüdeki 412 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 128 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM1 YOLO bbox | 128 | 0.909 | 0.921 | 0.920 | 0.925 | 0.930 | 0.920 | 0.881 |
| SAM2 GT bbox | 128 | 0.837 | 0.902 | 0.893 | 0.924 | 0.961 | 0.867 | 0.325 |
| SAM2 YOLO bbox | 128 | 0.789 | 0.849 | 0.839 | 0.873 | 0.900 | 0.799 | 0.342 |
| SAM3 GT bbox | 128 | 0.798 | 0.877 | 0.950 | 0.826 | 0.966 | 0.740 | 0.248 |
| SAM3 YOLO bbox | 128 | 0.752 | 0.826 | 0.897 | 0.776 | 0.908 | 0.697 | 0.216 |

### Overlap × Low Mask Area

Referans: Yeniden üretilmiş SAM1 pseudo referansı. Bu tablo 128 görüntüdeki 1.209 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 128 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM1 YOLO bbox | 128 | 0.678 | 0.691 | 0.697 | 0.689 | 0.706 | 0.683 | 0.632 |
| SAM2 GT bbox | 128 | 0.701 | 0.815 | 0.733 | 0.957 | 0.897 | 0.445 | 0.034 |
| SAM2 YOLO bbox | 128 | 0.511 | 0.588 | 0.532 | 0.681 | 0.647 | 0.370 | 0.031 |
| SAM3 GT bbox | 128 | 0.780 | 0.871 | 0.895 | 0.867 | 0.970 | 0.706 | 0.071 |
| SAM3 YOLO bbox | 128 | 0.563 | 0.624 | 0.650 | 0.611 | 0.691 | 0.535 | 0.064 |

### Overlap × High Mask Area

Referans: Yeniden üretilmiş SAM1 pseudo referansı. Bu tablo 128 görüntüdeki 1.806 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 128 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM1 YOLO bbox | 128 | 0.897 | 0.905 | 0.907 | 0.903 | 0.914 | 0.908 | 0.877 |
| SAM2 GT bbox | 128 | 0.829 | 0.899 | 0.857 | 0.962 | 0.966 | 0.819 | 0.358 |
| SAM2 YOLO bbox | 128 | 0.778 | 0.837 | 0.804 | 0.883 | 0.901 | 0.802 | 0.365 |
| SAM3 GT bbox | 128 | 0.836 | 0.905 | 0.948 | 0.874 | 0.980 | 0.837 | 0.333 |
| SAM3 YOLO bbox | 128 | 0.775 | 0.835 | 0.880 | 0.802 | 0.908 | 0.782 | 0.322 |

## Reference Bias Comparison

Görüntü, instance, bbox istemi ve model tahmini aynıdır; yalnız değerlendirme referansı Yayınlanmış SAMRS referansı yerine Yeniden üretilmiş SAM1 pseudo referansı olarak değiştirilmiştir.

| Model | BBox | Temel Referans IoU | Reference IoU | IoU Farkı |
| --- | --- | --- | --- | --- |
| SAM1 | GT bbox | 0.991 | 1.000 | +0.009 |
| SAM1 | YOLO bbox | 0.813 | 0.818 | +0.005 |
| SAM2 | GT bbox | 0.781 | 0.785 | +0.004 |
| SAM2 | YOLO bbox | 0.679 | 0.682 | +0.004 |
| SAM3 | GT bbox | 0.808 | 0.813 | +0.005 |
| SAM3 | YOLO bbox | 0.691 | 0.695 | +0.004 |
...
- SAM1 modeli YOLO bbox koşulunda temel referansa karşı 0.813, kendi öğretmen ailesinin referansına karşı 0.818 Avg IoU verir; görünür fark +0.005'tür.
