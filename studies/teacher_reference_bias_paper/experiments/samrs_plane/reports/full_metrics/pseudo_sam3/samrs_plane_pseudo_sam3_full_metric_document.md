# SAMRS SOTA Plane - SAM3 pseudo referansı Full Metric Document
...
- Bu belgede değerlendirme referansı SAM3 pseudo referansı ve değerlendirilen instance sayısı 3.713.
...
Referans: SAM3 pseudo referansı. Bu tablo 512 görüntüdeki 3.713 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 512 | 0.813 | 0.890 | 0.868 | 0.929 | 0.975 | 0.783 | 0.227 |
| SAM1 YOLO bbox | 512 | 0.695 | 0.757 | 0.734 | 0.793 | 0.829 | 0.684 | 0.211 |
| SAM2 GT bbox | 512 | 0.751 | 0.850 | 0.770 | 0.970 | 0.943 | 0.592 | 0.081 |
| SAM2 YOLO bbox | 512 | 0.643 | 0.724 | 0.660 | 0.819 | 0.809 | 0.527 | 0.077 |
| SAM3 GT bbox | 512 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM3 YOLO bbox | 512 | 0.799 | 0.819 | 0.823 | 0.818 | 0.840 | 0.813 | 0.720 |

### No Overlap × Low Mask Area

Referans: SAM3 pseudo referansı. Bu tablo 128 görüntüdeki 286 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 128 | 0.825 | 0.900 | 0.890 | 0.922 | 0.986 | 0.839 | 0.189 |
| SAM1 YOLO bbox | 128 | 0.671 | 0.732 | 0.714 | 0.761 | 0.794 | 0.678 | 0.182 |
| SAM2 GT bbox | 128 | 0.761 | 0.855 | 0.783 | 0.967 | 0.934 | 0.671 | 0.066 |
| SAM2 YOLO bbox | 128 | 0.622 | 0.698 | 0.637 | 0.791 | 0.762 | 0.531 | 0.063 |
| SAM3 GT bbox | 128 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM3 YOLO bbox | 128 | 0.759 | 0.783 | 0.778 | 0.793 | 0.804 | 0.787 | 0.654 |

### No Overlap × High Mask Area

Referans: SAM3 pseudo referansı. Bu tablo 128 görüntüdeki 412 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 128 | 0.798 | 0.877 | 0.826 | 0.950 | 0.966 | 0.740 | 0.248 |
| SAM1 YOLO bbox | 128 | 0.744 | 0.821 | 0.770 | 0.896 | 0.908 | 0.675 | 0.197 |
| SAM2 GT bbox | 128 | 0.801 | 0.885 | 0.819 | 0.977 | 0.985 | 0.718 | 0.167 |
| SAM2 YOLO bbox | 128 | 0.746 | 0.827 | 0.762 | 0.919 | 0.925 | 0.660 | 0.143 |
| SAM3 GT bbox | 128 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM3 YOLO bbox | 128 | 0.901 | 0.919 | 0.919 | 0.923 | 0.937 | 0.908 | 0.869 |

### Overlap × Low Mask Area

Referans: SAM3 pseudo referansı. Bu tablo 128 görüntüdeki 1.209 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 128 | 0.780 | 0.871 | 0.867 | 0.895 | 0.970 | 0.706 | 0.071 |
| SAM1 YOLO bbox | 128 | 0.564 | 0.625 | 0.619 | 0.642 | 0.695 | 0.531 | 0.060 |
| SAM2 GT bbox | 128 | 0.685 | 0.806 | 0.710 | 0.961 | 0.907 | 0.354 | 0.005 |
| SAM2 YOLO bbox | 128 | 0.487 | 0.571 | 0.506 | 0.680 | 0.653 | 0.254 | 0.003 |
| SAM3 GT bbox | 128 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM3 YOLO bbox | 128 | 0.655 | 0.679 | 0.686 | 0.676 | 0.706 | 0.674 | 0.530 |

### Overlap × High Mask Area

Referans: SAM3 pseudo referansı. Bu tablo 128 görüntüdeki 1.806 uçak örneğini kapsar. YOLO bbox değerleri sabit seed 42 sonucudur.

| Pipeline | Images | Avg IoU | Avg Dice | Avg Precision | Avg Recall | IoU ≥ 0.50 | IoU ≥ 0.75 | IoU ≥ 0.90 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SAM1 GT bbox | 128 | 0.836 | 0.905 | 0.874 | 0.948 | 0.980 | 0.837 | 0.333 |
| SAM1 YOLO bbox | 128 | 0.775 | 0.836 | 0.807 | 0.876 | 0.906 | 0.790 | 0.321 |
| SAM2 GT bbox | 128 | 0.782 | 0.870 | 0.797 | 0.974 | 0.960 | 0.710 | 0.115 |
| SAM2 YOLO bbox | 128 | 0.728 | 0.806 | 0.744 | 0.892 | 0.894 | 0.678 | 0.114 |
| SAM3 GT bbox | 128 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| SAM3 YOLO bbox | 128 | 0.879 | 0.895 | 0.899 | 0.894 | 0.913 | 0.889 | 0.824 |
...
| --- | --- | --- | --- | --- |
| SAM1 | GT bbox | 0.991 | 0.813 | -0.178 |
| SAM1 | YOLO bbox | 0.813 | 0.695 | -0.118 |
| SAM2 | GT bbox | 0.781 | 0.751 | -0.030 |
| SAM2 | YOLO bbox | 0.679 | 0.643 | -0.035 |
| SAM3 | GT bbox | 0.808 | 1.000 | +0.192 |
| SAM3 | YOLO bbox | 0.691 | 0.799 | +0.108 |
...
- SAM3 modeli YOLO bbox koşulunda temel referansa karşı 0.691, kendi öğretmen ailesinin referansına karşı 0.799 Avg IoU verir; görünür fark +0.108'tür.
