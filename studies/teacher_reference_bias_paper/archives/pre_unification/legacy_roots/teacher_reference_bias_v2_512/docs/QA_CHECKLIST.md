...
- [x] Train/validation/test kaynak sahne kesişimleri sıfır.
...
- [x] Altı YOLO eğitimi tamamlandı.
- [x] Validation confidence eşikleri testten önce donduruldu.
- [x] Altı YOLO test bbox değerlendirmesi tamamlandı.

## Segmentasyon

- [x] İki veri setinde üç GT-bbox segmenter koşulu tamamlandı.
- [x] iSAID SAM1 pseudo referansı donduruldu.
- [x] İki veri setinde dokuzar YOLO-bbox koşulu tamamlandı.
