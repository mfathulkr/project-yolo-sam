...
- SAM3 bbox inference: her kutu için tek instance maskesi üreten Sam3Tracker PVS arayüzü; PCS visual-exemplar arayüzü kullanılmaz.
...
- [Kritik uygulama kararları ve tekrar üretim rehberi](docs/REPRODUCIBILITY_FIELD_GUIDE.md)
- [Literatür incelemesi](docs/LITERATURE_REVIEW.md)
- [Literatür tarama denetimi ve düzeltme kaydı](docs/LITERATURE_SEARCH_AUDIT.md)
...
- [SAM3 düzeltme ve yeniden üretim denetimi](docs/SAM3_CORRECTION_AUDIT.md)
...
Komutlardan önce [tekrar üretim rehberindeki](docs/REPRODUCIBILITY_FIELD_GUIDE.md)
PVS/PCS ayrımı, detector confidence seçimi, YOLO-GT eşleştirmesi,
known-positive empty politikası ve instance-macro metrik sözleşmesi
okunmalıdır. Bu kararlardan biri değiştirilirse aynı bilimsel deney yeniden
üretilmiş sayılmaz.
