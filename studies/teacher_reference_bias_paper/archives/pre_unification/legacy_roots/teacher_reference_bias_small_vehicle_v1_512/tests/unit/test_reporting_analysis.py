...
from yolo_sam.data.isaid import normalize_category_name
...
class ReportingAnalysisTest(unittest.TestCase):
    def test_small_vehicle_category_normalization_matches_isaid(self) -> None:
        self.assertEqual(normalize_category_name("small vehicle"), "small_vehicle")
