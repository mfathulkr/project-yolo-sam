...
test kümesine alınmaz. `High/Low Mask Area`, görüntüdeki referans küçük araç
instance maskelerinin alanları toplamının her veri seti için v1 aday havuzundan dondurulan eşiğin
üstünde veya altında olmasına göre belirlenir. Eşik test sonucuna bakılarak
seçilmez. Bu değer maskelerin union alanı değildir; iki instance maskesi
örtüşüyorsa ortak piksel her instance alanında ayrı sayılabilir.
...
SAM3, her bbox için tek bir belirli-instance maskesi üreten `Sam3Tracker` PVS
arayüzüyle çalıştırılır. Kavram benzerliği arayan PCS visual-exemplar arayüzü
bu deneyde kullanılmaz. Maske logit eşiği 0,0'dır; hesaplama batch'i sonucu ve
instance sırasını değiştirmez.
...
Her değerlendirme satırı bilinen pozitif bir GT instance'ı temsil eder. Bu
nedenle pseudo referans boşsa, öğrenci tahmini de boş olsa bile sonuç başarı
sayılmaz; IoU, Dice, Precision ve Recall 0,0 olur. Gerçekten hedef bulunmayan
görüntüler için kullanılabilecek genel boş-boş eşitliği bu instance deneyine
uygulanmaz.
