...
def metric_bullets(
    ...
    return (
        ...
        f"Her satırda temel veri seti anotasyonuyla varlığı bilinen bir {target_label} vardır. Bu nedenle boş pseudo referans eksik etikettir; tahmin de boş olsa bile maske metrikleri 0 kabul edilir ve referans kapsama kaybı ayrıca raporlanır.",
