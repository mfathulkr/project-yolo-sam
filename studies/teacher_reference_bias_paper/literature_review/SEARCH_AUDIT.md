...
> three evaluated SAM models under independent iSAID human controls, and
> complements this with published-versus-reproduced SAMRS reference analyses.
...
- SAMRS yayımlanmış maskeleri insan referansı diye adlandırılmaz; iSAID ana
