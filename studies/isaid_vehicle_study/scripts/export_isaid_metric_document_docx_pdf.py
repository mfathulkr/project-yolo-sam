...
QUALITATIVE_IMAGES = [
    (
        ...
        STUDY_ROOT / "reports" / "figures" / "sample_cases" / "no_overlap__low_mask_area__P2766_0016_hero.png",
    ),
    (
        "No Overlap / High Mask Area",
        STUDY_ROOT / "reports" / "figures" / "sample_cases" / "no_overlap__high_mask_area__P0199_0002_hero.png",
    ),
    (
        "Overlap / Low Mask Area",
        STUDY_ROOT / "reports" / "figures" / "sample_cases" / "overlap__low_mask_area__P2404_0002_hero.png",
    ),
    (
        "Overlap / High Mask Area",
        STUDY_ROOT / "reports" / "figures" / "sample_cases" / "overlap__high_mask_area__P2781_0005_hero.png",
    ),
]
