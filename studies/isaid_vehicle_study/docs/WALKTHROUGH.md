...
```text
studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
```

Hazır dataset:

```text
studies/isaid_vehicle_study/data/prepared/
```

Eval split:

```text
studies/isaid_vehicle_study/data/prepared/eval/
```
...
```text
studies/isaid_vehicle_study/results/detector_training/yolo26x_isaid_vehicle_s1024/train/weights/best.pt
```
...
```text
/home/ssyzai/projects/yolo-sam/project-yolo-sam/datasets/isaid/raw/
/home/ssyzai/projects/yolo-sam/project-yolo-sam/datasets/isaid/downloads/
/home/ssyzai/projects/yolo-sam/project-yolo-sam/studies/isaid_vehicle_study/data/prepared/
```
...
```text
/home/ssyzai/projects/yolo-sam/project-yolo-sam/studies/isaid_vehicle_study/results/detector_training/yolo26x_isaid_vehicle_s1024/train/
```

YOLO26x eğitim çıktısı ve `best.pt`.

```text
/home/ssyzai/projects/yolo-sam/project-yolo-sam/studies/isaid_vehicle_study/results/pipelines/
```
...
```bash
.venv/bin/python tools/pipelines/run_sam3_text.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python tools/pipelines/run_remotesam_text.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python studies/isaid_vehicle_study/scripts/run_segearth_ov3.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python tools/pipelines/run_yolo_sam3.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python tools/pipelines/run_gt_box_sam3.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python tools/pipelines/run_yolo_sam2.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python studies/isaid_vehicle_study/scripts/run_grounded_sam2.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python tools/pipelines/run_ringmo_sam.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python tools/pipelines/evaluate_stratified_triplet.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python studies/isaid_vehicle_study/scripts/export_curated_qualitative_examples.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python studies/isaid_vehicle_study/scripts/write_isaid_experiment_report.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python studies/isaid_vehicle_study/scripts/export_isaid_presentation_pdf.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
.venv/bin/python studies/isaid_vehicle_study/scripts/validate_isaid_experiment_outputs.py --config studies/isaid_vehicle_study/configs/yolo26x_cpu_eval.yaml
```
