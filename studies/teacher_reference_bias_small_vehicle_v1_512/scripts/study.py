...
from yolo_sam.data.profiles import get_dataset_profile, normalize_category_name
...
def build_parser() -> argparse.ArgumentParser:
    ...
    audit_parser.add_argument(
        ...
        type=Path,
        default=Path(
            "studies/teacher_reference_bias_small_vehicle_v1_512/results/dataset_audits"
        ),
    )
    ...
    preflight_parser.add_argument(
        ...
        type=Path,
        default=Path(
            "studies/teacher_reference_bias_small_vehicle_v1_512/results/preflight.json"
        ),
    )
    ...
    train_parser.add_argument(
        "--resume",
        action="store_true",
        help="Resume an interrupted detector run from train/weights/last.pt.",
    )
...
def preflight_command(args: argparse.Namespace) -> int:
    ...
    target_categories = {
        normalize_category_name(dataset.target_category) for dataset in datasets
    }
