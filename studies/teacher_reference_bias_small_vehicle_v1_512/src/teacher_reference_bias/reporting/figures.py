...
def gt_bbox_reference_comparison(
    ...
    configure_style()
    panels = [
        ("isaid_small_vehicle", "human", "iSAID · Human Reference"),
        ("isaid_small_vehicle", "pseudo_sam1", "iSAID · SAM1 Pseudo Reference"),
        ("samrs_sota_small_vehicle", "pseudo_sam1", "SAMRS SOTA · SAM1 Pseudo Reference"),
    ]
...
def reference_inflation_figure(
    ...
    configure_style()
    selected = inflation[
        (inflation["dataset_id"] == "isaid_small_vehicle")
...
def strata_heatmap(
    ...
    configure_style()
    conditions = [
        ("isaid_small_vehicle", "human", "iSAID · Human"),
        ("isaid_small_vehicle", "pseudo_sam1", "iSAID · SAM1 Pseudo"),
        ("samrs_sota_small_vehicle", "pseudo_sam1", "SAMRS · SAM1 Pseudo"),
    ]
