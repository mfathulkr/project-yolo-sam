...
def run_gt_box_sam1_pipeline(
    ...
    for index, image_path in enumerate(tqdm(list_images(images_dir), desc="GT bbox + SAM1"), start=1):
        ...
        if not boxes_list:
            ...
            raw_payload = {"num_boxes": 0, "num_masks": 0, "scores": [], "input_boxes": [], "prompt_type": "gt_bbox"}
        else:
